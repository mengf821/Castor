...
class Trainer(object):
    ...
    def __init__(self, model, embedding, train_loader, trainer_config, train_evaluator, test_evaluator, dev_evaluator=None, use_elmo=False):
        self.model = model
    ...
    def get_sentence_embeddings(self, batch):
        ...
        if self.elmo:
            ...
            print(str(sent1.size()))
            print(str(sent2.size()))
